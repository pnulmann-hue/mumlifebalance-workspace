...
# Variante C — Zentrale Pitch-Sequenz „Hoch ankern → Diagnose-Downsell" (mit Webinar-Brücke)

**6 Mails, alle 3-4 Tage. Jede Mail: 1 Emotion + 1 konkreter Tipp + 1 CTA.**
Platzhalter: `[DATUM]`, `[WEBINAR-LINK]`, `[MBA-SALESPAGE]`, `[KUNDINNEN-STIMME]`, `[MINIKURS-LINK]`, `[333-LINK]`. Keine erfundenen Zahlen/Stimmen.

> INTERN. Gegen KI-Phrasen-Blackliste geprüft (kein Nicht/Sondern, kein Dreier-Stakkato, kein „Stell dir vor", kein „6-stellig", kein Mentorin-Name).
...
Ganz ehrlich: die meisten Network-Mamas, die mir schreiben, haben das gleiche Bild. Eine hübsche Seite, ein paar hundert Followerinnen, regelmässig was gepostet — und im Posteingang bleibt es ruhig. Das frisst, weil du ja arbeitest. Es kommt nur nichts zurück.

Der häufigste Grund: deine Bio sagt, *was du verkaufst*, statt *wem du hilfst*. Dreh das heute um. Schreib einen Satz nach diesem Muster:
...
Mach das einmal für dich. Und wenn du magst, antworte mir direkt auf diese Mail mit deinem Satz — ich les jede Antwort.
...
## Mail 3 · Tag 6 · Wende-Story → Webinar-Brücke (MBA)
...
Ich sass mit meiner Tochter im Wellness, Handy eigentlich weg, und dann kam diese Mail rein: Zahlungseingang. Jemand hatte über mein Instagram-Profil einfach gekauft, während ich im Bademantel lag. Mega puff. Ich konnte es kaum fassen.

Das Verrückte daran: das war kein Glück. Das passiert, seit bei mir vier Dinge zusammenspielen — mein Thema, eine Positionierung, die sofort verstanden wird, ein Angebot, das wirklich passt, und ein KI-System, das im Hintergrund weiterläuft, auch wenn ich gerade Mama bin. Seitdem gibt es bei mir keinen Monat mehr ohne Verkauf, mit 18 Stunden Arbeit pro Woche und vier Kindern.

Ein Stück davon kannst du sofort mitnehmen: ein einziger Beitrag pro Woche, der ein echtes Problem deiner Wunschkundin löst, bringt dir mehr als zehn Produktbilder. Fang da an.

Das ganze System — wie die vier Teile ineinandergreifen — zeig ich dir live im kostenlosen Webinar. Komm dazu, es lohnt sich.
...
## Mail 4 · Tag 9 · MBA — alles aus einer Hand + Beweis
...
„Wo soll ich überhaupt anfangen?" — diese Frage kriege ich fast täglich. Und ich versteh sie, weil du an zehn Ecken gleichzeitig ziehst: Thema, Posten, eigenes Produkt, Zeit, Technik. Da verzettelt man sich.
...
- dein eigenes digitales Produkt, aufgebaut Schritt für Schritt
- dein KI-System, das dir den Adminkram im Business und im Haushalt abnimmt
- der Weg vom „paar hundert Franken" zu echtem, planbarem Einkommen
...
Wenn dich seit Wochen das Gefühl begleitet „ich will das endlich vergrössern" — das hier ist dein Moment.
...
## Mail 6 · Tag 15 · Diagnose-Downsell (der EINE passende 333er)

> AC-Logik: Inhalt richtet sich nach dem Einstiegs-Freebie / Tag.
> BIO · LEAD · STORY → Instagram-Kundenmaschine · QUIZ · ECHT1 → Digitale Produktwelt · Zeit/Familie → Mama-CEO.
...
Such dir den einen Bereich, der dich heute am meisten bremst:

**→ Wenn dir Kundinnen über Instagram fehlen:**
Die Instagram-Kundenmaschine bringt dir Thema, Positionierung und Strategie, damit sich die richtigen Frauen melden. 333 CHF. [333-LINK]

**→ Wenn du dein Wissen zu einem eigenen Produkt machen willst:**
Die Digitale Produktwelt zeigt dir Schritt für Schritt, wie aus deinem Können ein verkaufbares Produkt wird. 333 CHF. [333-LINK]

**→ Wenn dir vor allem die Zeit fehlt:**
Mama-CEO baut dir das KI-System, das dir den Hintergrundkram abnimmt, damit dein Business in deine 18 Stunden passt. 333 CHF. [333-LINK]

Fang dort an, wo es am meisten weh tut. Den Rest holst du später nach.

Liebe Grüsse
Patricia

**CTA-Button:** Meinen Startpunkt wählen → [333-LINK passend]

---

## Danach (alle Nicht-Käuferinnen)

Exit-Tag `pitch-durchlaufen-kein-kauf` → allgemeiner Verteiler. Dort laufende Mehrwert-Mails + Pitch bei jedem MBA-Launch. Quartalsweise Reaktivierung + Bereinigung (siehe [[blueprint]] Abschnitt „Was passiert am Ende").
