...
- **„Stimm-Check“**: Auslöser Tag `0€ Stimmcheck` → Wenn/Dann Datum vor 8.10. → `stimm-01-auslieferung.html` (mit Masterclass-Kasten), sonst `stimm-01b-auslieferung.html` (ohne) · beide mit persönlichem Tool-Link `?e=%EMAIL%&n=%FIRSTNAME%`
...
### Die Mails (16, alle fertig · Stand 26.09.)
