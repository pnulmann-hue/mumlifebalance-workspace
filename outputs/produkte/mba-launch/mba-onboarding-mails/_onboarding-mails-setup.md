...
2. **`[UMSETZERINNEN-GRUPPE-LINK]`** — der Telegram-Einladungslink der **Umsetzerinnen-Gruppe** (die bezahlte Mitglieder-Gruppe — NICHT die Bootcamp-Gruppe!).
   → Die musst du noch erstellen, falls noch nicht geschehen. Eigene, neue Telegram-Gruppe nur für MBA-Mitglieder.
