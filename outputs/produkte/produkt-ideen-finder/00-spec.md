...
6. **Brücke (weich, EIN Haupt-CTA):** → **„Vom Network-Wissen zum eigenen Produkt" (39)** — „so machst du aus deiner Idee ein fertiges kleines Produkt, das dir Menschen bringt". Die Positionierungs-Botschaft (Thema statt Produkt / Expertin statt Verkäuferin) bleibt der emotionale Rahmen des Fazits, aber es gibt nur **einen** CTA.

**Order Bump (im 39er-Checkout):** **„Expertin statt Verkäuferin" (97)** — perfekte Ergänzung (Produkt bauen + als Expertin positionieren). Nicht im Tool-Fazit pitchen, sondern als „das will ich auch noch dazu" am Checkout → hebt den Bestellwert 39 → 136. Danach Treppe weiter → 333er → MBA.
