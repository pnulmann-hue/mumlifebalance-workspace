...
L44 = [
 ...
 {"t":"Stufe 2: der automatische Telegram-Bot","b":["Server läuft 24/7 → pusht um 6:30","Brauchst: Telegram-Bot + Hosting + etwas Code","Läuft auch wenn der Laptop zu ist"],"n":"Und für die, die irgendwann Blut lecken, zeig ich dir ehrlich, wie die Profi-Variante läuft. Das ist ein Bot, der Tag und Nacht auf einem kleinen Server liegt und mir jeden Morgen um halb sieben von selbst eine Telegram-Nachricht schickt. Dafür braucht es drei Dinge: du meldest deinen Bot kostenlos bei Telegram an, du brauchst einen Ort wo er rund um die Uhr läuft, das nennt man Hosting, und du brauchst ein bisschen Code, der die Verbindung macht."},
