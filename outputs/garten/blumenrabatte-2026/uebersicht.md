---
tags: [garten, blumenrabatte, stauden]
---

# 🌺 Blumenrabatte 2026 — Übersicht

Neue Stauden-Rabatte, angelegt am **07.07.2026**. Alle Pflanzen von der **Biogärtnerei Neubauer, Erlen** (Bio-Suisse, [neubauer.ch](https://www.neubauer.ch/)).
Standort: **920 m, Appenzellerland** — neue, eigene Rabatte (nicht Teil des bestehenden Beet-Systems).

> Zweck dieser Notiz: festhalten **was** ich gekauft habe, **wo** es steht und ein **Foto-Beleg**, um im Frühjahr 2027 zu prüfen, welche Stauden wieder austreiben.

---

## Kommt es nächstes Jahr wieder?

| Pflanze | Botanisch | Winterhart auf 920 m? | Das Spezielle |
|---|---|---|---|
| Roter Sonnenhut (T13) | *Echinacea purpurea* | ✅ Ja | Bienen-/Schmetterlingsmagnet, Heilpflanze |
| Echinacea „Minibelle" | *E. purpurea* 'Minibelle' | ✅ Ja | Rarität: gefüllte, leuchtend-rosa Zwergform |
...
2. Behalten: **Anfang/Mitte September ausgraben**, in Topf, hell bei **10–15 °C** (Keller/Treppenhaus), sehr sparsam giessen. Ab Mitte Mai 2027 wieder raus.

---

## 📸 Foto-Beleg (07.07.2026)

Echte Kauf-Fotos, datiert abgelegt (bewusst nur lokal — Kinder im Bild):

![[fotos/einkaufswagen-neubauer-2026-07-07.jpg]]
*Der Einkaufswagen mit dem Neubauer-Haul.*

![[fotos/neubauer-schaubeet-echinacea-2026-07-07.jpg]]
*Schaubeet bei Neubauer — Echinacea mit dem typischen dunkelbraunen Neubauer-Etikett.*
...
## 🔗 Verwandte Notizen
- Notion: 🌺 Blumenrabatte 2026 — Übersicht (unter *Gartenassistent*)
- Notion Samen-DB — Beet-Filter *Blumenrabatte (neu 2026)*
- [[_MOCs/MOC-Garten|Garten-Map]]
