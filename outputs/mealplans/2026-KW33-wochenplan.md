...
# 🍽 Wochenplan Di 11.8 – Mo 17.8 (KW 33/34)

**Quelle aller Rezepte:** `kochwissen/Ernährungsplan Coaching AKTUELL 2026-08-10.pdf` (MyBodyAdvice by Lisa)
**Deine Makros:** 1850 kcal · 135 g Protein · 180 g KH · 63 g Fett

**So ist der Plan aufgebaut (genau wie du wolltest):**
- 🌅 **Frühstück + 🍝 Mittag** = familientauglich, du machst es für dich **und die Kids** (Portionen einfach hochskalieren, deine Menge steht in der Tabelle).
- 🌙 **Abend** = **nur für dich allein**, exakt deine Plan-Portion.
- Jede Kategorie deines Plans kommt **genau 1× pro Tag** vor → 7 Frühstücke, 7 Mittage, 7 Abende, alle verschieden.
- 🎒 **Dienstagabend = To-Go** fürs Picknick (siehe Box unten).
...
## 🎒 Dienstagabend To-Go — fürs Picknick zu Fuss

**Lisas Nudelbowl (Vollkorn)** — die perfekte kalte Bowl, die im Behälter nicht matschig wird:

- 65 g Emmer- (oder Vollkorn-)Nudeln nach Packung kochen, **kalt abschrecken**
- 45 g Tomate + 140 g Schafskäse light (Salakis) würfeln, 20 g Feldsalat, 10 g Bohnensprossen
- Mit 1 TL Olivenöl + 1–3 EL Balsamico, Kräutersalz + Pfeffer mischen
...
## 🛒 EINKAUFSLISTE — dein Fokus für morgen
...
### 🐟 Konserven / Vorrat
- **Thunfisch im Eigensaft** — **5 Dosen** (Mittag Mo für Familie + dein Abend-Kartoffelsalat So) — *dein Vorrat-Check: mind. 3 sollten eh da sein*
- **Kichererbsen Dose** — 3 Dosen (Abende Mi + Sa)
...
- **Butter** (gesalzen + ungesalzen) — *Immer-Check*
...
- **Gewürzgurken ohne Zucker** — 1 Glas · **Senf** *(Immer-Check)*
...
## 🍳 Vorbereiten spart dir Zeit

- **Di Abend:** Pistazien-Overnight-Oats für Mi ansetzen (5 Min, Skyr + Kokosdrink + Haferflocken + Chiasamen).
- **Di:** Beim Muffin-Backen gleich die **doppelte Menge Schoko-Muffins** → deckt Di + Do Znüni ab.
- **Do Abend:** Banana-Split-Chia-Pudding für Fr ansetzen.
- **Fr/Sa:** **Süsskartoffel-Brownies** als Batch backen → Sa + So Znüni (und die Kids freuen sich).
- **So:** Haferflockenbrötchen lassen sich morgens frisch backen (25 Min Ofen) — oder Sa Abend vorformen.
- **Feta-Abende (Di/Fr/Sa):** brauchen 0 Kochen — nur schneiden + mischen. Ideal nach einem langen Tag.
...
## 🌙 Hinweis Familien-Abende

Diese Woche sind **deine Abende Solo** (dein Wunsch). Der Mann/die Kids essen abends ihr Eigenes — ausser **Dienstag**, da geht ihr ja zusammen picknicken (deine To-Go-Box ist geplant, für die Familie reicht Brot/Käse/Obst + die Muffins aus dem Vorrat).
