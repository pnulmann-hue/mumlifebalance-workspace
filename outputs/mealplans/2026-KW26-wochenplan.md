...
# 🗓 Wochenplan — Do 25.6. bis Do 2.7. 2026

**Familie 5-6 Personen** · **Patricia-Makros (MyBodyAdvice):** 1850 kcal / 135g P / 180g KH / 63g Fett
...
>
> 📅 **Bootcamp:** Mo 29.6.–Do 2.7. läuft deine PIA-Challenge → diese 4 Tage bewusst low-effort (Reste, Pfanne, Ofen, Vorbereitetes). Hauptvorbereitung am Wochenende.

**🚫 Anti-Doppelung gegen KW24-25:** Kein Hacksteak, Pouletschenkel, Pasta al forno, Kalbsbratwurst, Kalbsschnitzel, Rindsschmorbraten, Käsehörnli, Pouletschnitzel Jägerart, Moussaka, Salbei-Carbonara, Flammkuchen, Schweinsbraten, Familien-Brunch — und nichts aus der kumulierten Liste. **Alle Gerichte unten = NEU.** ✓

---

## 🍽 Menüplan — Familie

| Datum | Tag | Hauptgericht Mittag (warm, 5-6 P) | Beilagen | Zeit | Abend (kalt, 6 P) | Methode | 📄 Quelle |
|---|---|---|---|---|---|---|---|
| 25.6. | Do | **Tomate-Mozzarella-Spaghetti** (Familien-Hit) | Salat | 25 Min | 🥙 **Pita-Taschen** mit Tzatziki + Aufschnitt + Gurke/Tomate | 🍝 Pfanne/TM | MBA-Plan S. 13 |
| 26.6. | Fr | **Hähnchen-Fajitas** (Blech + Wraps, Kinderhit!) | (im Wrap) | 30 Min | 🫒 **Antipasti-Platte**: Mozzarella + Soft-Tomaten + Oliven + Salami + Brot | 🔥 Blech | MBA-Plan S. 11 |
| 27.6. | Sa | **Reis-Paprika-Pfanne mit Hackfleisch** (DOPPELT → Bootcamp-Reste!) | (One-Pan) | 25 Min | 🥗 **Sommer-Salat-Buffet**: Blattsalate + Eier + Brot + Käse | 🍳 Pfanne | MBA-Plan S. 13 |
| 28.6. | So | 🔥 **Sonntags-Grilladen: Black Angus Minutensteaks** (Aktion!) + Grillgemüse + Kräuterbutter | Folienkartoffeln + Salat | 40 Min | 🥙 **Reste-Bowl**: Steak kalt + Grillgemüse + Brot + Senf-Dip | 🔥 Grill | Grilltechnik |
| 29.6. | Mo | **Reis-Paprika-Reste vom Sa** (Bootcamp Tag 1 — aufwärmen!) | Salat | 10 Min | 🌯 **Quesadillas mit Resten**: Tortilla + Reste + Käse, kurz in Pfanne | ♻️ Reste | MBA-Plan S. 13 |
| 30.6. | Di | **Cremige Protein-Gemüsepasta** | (mit Salat) | 20 Min | 🧀 **Käseplatte**: Gruyère AOP (Aktion!) + Trauben + Nüsse + Brot | 🍝 Pfanne/Mixer | MBA-Plan S. 14 |
| 1.7. | Mi | **Ofengemüse mit Hähnchen** (Ofen = Hände frei) | (Wurzelgemüse) | 10 Min Prep + 40 Min Ofen | 🥪 **Wurst-Käse-Brett** + Gemüsesticks | 🔥 Ofen | MBA-Plan S. 10 |
| 2.7. | Do | **Zucchini-Kichererbsen-Pfanne** (Zucchini-Aktion; Feta nur Patricia) | (One-Pan) | 15 Min | 🥖 **Bauernbrot-Buffet** + Aufstriche + hartgek. Eier | 🍳 Pfanne | MBA-Plan S. 14 |

> **Familien-Anpassungen:** Cremige Gemüsepasta (Di) für Familie ohne Rucola, mit extra Parmesan; optional Pouletstreifen. Zucchini-Kichererbsen-Pfanne (Do 2.7.): Feta nur über Patricias Portion, Familie mit Mozzarella/Reibkäse.

---

## 🥗 Patricia-Tagesplan (MyBodyAdvice — aktueller Plan)
...
## 🔥 Aktionen genutzt (Migros Ostschweiz, ca. 23.6.-8.7.)

- 🥩 **Black Angus Steaks -33%** → **So Grilladen** + Reste Mo-Abend
- 🧀 **Le Gruyère AOP -30%** → **Di Käseplatte** + Reibkäse
- 🍝 **Agnesi Pasta -40%** → Spaghetti (Do) + Nudeln auf Vorrat
- 🍑 **Aprikosen -34% + Pfirsiche** → Pfirsich-Crostini + belegtes Brot + Dessert + Znüni
...
## 🌙 Abendessen-Details (Familie kalt, 6 P · Patricia separat MBA)

| Tag | Familien-Thema (kalt) | Aufbau | Patricia MBA-Abend |
|---|---|---|---|
| **Do** | 🥙 Pita-Taschen | Pitas + Tzatziki + Aufschnitt + Gurke/Tomate/Salat | **Sommersalat m. Hähnchen & Erdbeeren** (Quinoa + Römersalat) |
| **Fr** | 🫒 Antipasti-Platte | Mozzarella + Soft-Tomaten + Oliven + Salami + Brot + Eier | **Schneller Thunfischsalat m. Brot** (Quark + Sellerie + Dill) |
...
**Trick:** Beeren mit etwas Fett (Walnüsse, Mandelmus, Skyr) kombinieren → die fettlöslichen Pflanzenstoffe werden besser aufgenommen. TK-Beeren sind gleichwertig.
