...
const HTML_PATH = path.join(REPO_ROOT, 'outputs', 'funnels', 'doterra-hormon-leadmagnet', 'leadmagnet.html');
const OUTPUT_PDF = path.join(REPO_ROOT, 'outputs', 'funnels', 'doterra-hormon-leadmagnet', '4-erkenntnisse-hormonchaos.pdf');
