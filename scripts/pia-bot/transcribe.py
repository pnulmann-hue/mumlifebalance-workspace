"""Whisper-Transkription für PIA — Sprachnotizen der Teilnehmerinnen → Text.

Optional: wenn OPENAI_API_KEY fehlt, meldet is_available() False und der Bot
bittet um Text-Antworten.
"""
