...
4a. ⭐ **`context/content-formel-5-typen.md` — PFLICHT (seit 2026-06-01)**: die 5-Typen-Content-Formel aus der Mentorin-Profil-Analyse — 5 Post-Typen (Lifestyle/Freiheit · Tutorial-Karussell · Reel-CTA · Meinungs-Post · Social-Proof), Keyword-Kommentar-System (ein ManyChat-Keyword pro Post), Wochen-Content-Mix mit Typ-Rotation, Stop-Scrolling-Cover. **4 Leitplanken beachten:** (1) Keine Stakkato — Patricia-Voice gewinnt über Mentorin-Hook-Stil; (2) doTERRA bleibt Reels-only-Phase unter ~300-500 Followern, Karussells pausieren; (3) Keyword-CTA = bestehende ManyChat-Keywords; (4) keine erfundenen Zahlen. Beim Build: Post-Typen über die Woche rotieren, Cover als Scroll-Stopper bauen.
4b. ⭐ **`context/reichweiten-formel-mama-identity.md` — PFLICHT (seit 2026-06-01)**: der Reichweiten-Motor (Konkurrenz-Analyse). **Wochen-Struktur 3+1 pro Profil:** 3 Reichweiten-Posts (Gesellschaftsspiegel · Mama-Alltag-Moment · Ehrlichkeits-Story) mit **Share-CTA** statt Produkt-Keyword + 1 Lead-Post mit Keyword. Beim Build: Reichweiten-Posts NICHT mit Produkt-CTA überladen — Share-CTA („Schick das einer Mama…") drauf, Keyword nur auf den Lead-Post. „Stell dir vor" gesperrt (Blackliste) → szenen-malen / „Was wäre wenn".
4c. 🚀 **MBA-LAUNCH-MODUS — PFLICHT IM FENSTER (KW 24–27, 12.6.–6.7.2026)**: Wenn die Build-Woche ganz/teilweise im Launch-Fenster liegt, lies `outputs/produkte/mba-launch/feed-content-plan.md` + `story-plan-tag-fuer-tag.md` + `launch-kalender-juli-2026.md`. **Launch-Vorrang:** Baue die Mentoring-Karussells/Reels nach der **Launch-Phase** der Woche (Aufwärm = Reichweite + Webinar-Anmeldung · Verkauf = Beweis + Cart · Cart-Close = Countdown) aus dem Feed-Plan — nicht freie Themen. Keyword-CTA der Woche = Webinar / KI / Cart (statt Standard-Funnel-Keyword). Schedule-Slots ggf. an die Launch-Tage anpassen. doTERRA läuft normal weiter.
